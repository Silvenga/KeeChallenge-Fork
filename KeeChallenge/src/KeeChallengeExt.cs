...
namespace KeeChallenge
{
    public sealed class KeeChallengeExt : Plugin
    {
        ...
        public override bool Initialize(IPluginHost host)
        {
            ...
            int slot = Properties.Settings.Default.YubikeySlot - 1;
            ...
            m_YubiSlot1.Click += (s, e) =>
            {
                m_YubiSlot2.Checked = false;
                m_prov.YubikeySlot = YubiSlot.SLOT1;
            };
            ...
            m_YubiSlot2.Click += (s, e) =>
            {
                m_YubiSlot1.Checked = false;
                m_prov.YubikeySlot = YubiSlot.SLOT2;
            };
